# BP_L4_CloudFrame1_Piece2

## 1. 蓝图定位

本文档由 Docs/BlueprintExports/BP_L4_CloudFrame1_Piece2.json 自动整理生成，用于记录当前蓝图的真实导出结构。

## 2. 基础信息

1. 蓝图名：BP_L4_CloudFrame1_Piece2
1. 资源路径：/Script/Engine.Blueprint'/Game/UI/Level4/Pieces/BP_L4_CloudFrame1_Piece2.BP_L4_CloudFrame1_Piece2'
1. 蓝图类型：Blueprint
1. 父类：CaissonCeiling.Level4PuzzlePieceActor
1. 生成类：BP_L4_CloudFrame1_Piece2_C
