...
本文档由 Docs/BlueprintExports/W_Level4_Introdection.json 自动整理生成，用于记录当前蓝图的真实导出结构。

## 2. 基础信息

1. 蓝图名：W_Level4_Introdection
1. 资源路径：/Script/UMGEditor.WidgetBlueprint'/Game/UI/W_Level4_Introdection.W_Level4_Introdection'
1. 蓝图类型：WidgetBlueprint
1. 父类：UMG.UserWidget
1. 生成类：W_Level4_Introdection_C
...
1. Level4ShowcaseRef
   类型：object -> /Script/Engine.BlueprintGeneratedClass'/Game/UI/BP_ShowcaseModel_Level4.BP_ShowcaseModel_Level4_C'
   显示名：Level 4Showcase Ref
...
1. 模块数：2
1. 连接数：1
1. 执行链：BndEvt__W_Level1_Introdection_按钮-关闭_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature -> ExecuteUbergraph_W_Level4_Introdection
1. 关键节点：
   - ExecuteUbergraph_W_Level4_Introdection
...
1. 模块数：2
1. 连接数：1
1. 执行链：Construct -> ExecuteUbergraph_W_Level4_Introdection
1. 关键节点：
   - ExecuteUbergraph_W_Level4_Introdection
