...
### 8.3 Event_PlayDustTransition

1. 图类型：BlueprintGraph.EdGraphSchema_K2
1. 模块数：2
1. 连接数：1
1. 执行链：Event_PlayDustTransition -> ExecuteUbergraph_BP_ShowcaseModel_Level3
1. 关键节点：
   - ExecuteUbergraph_BP_ShowcaseModel_Level3
     输入：execute <- Event_PlayDustTransition:then
   - Event_PlayDustTransition

### 8.4 Event_PlayOilTransition

1. 图类型：BlueprintGraph.EdGraphSchema_K2
1. 模块数：2
1. 连接数：1
1. 执行链：Event_PlayOilTransition -> ExecuteUbergraph_BP_ShowcaseModel_Level3
1. 关键节点：
   - ExecuteUbergraph_BP_ShowcaseModel_Level3
     输入：execute <- Event_PlayOilTransition:then
   - Event_PlayOilTransition

### 8.5 InitializeLevel3VisualMaterials

1. 图类型：BlueprintGraph.EdGraphSchema_K2
1. 模块数：2
1. 连接数：1
1. 执行链：InitializeLevel3VisualMaterials -> ExecuteUbergraph_BP_ShowcaseModel_Level3
1. 关键节点：
   - InitializeLevel3VisualMaterials
   - ExecuteUbergraph_BP_ShowcaseModel_Level3
     输入：execute <- InitializeLevel3VisualMaterials:then

### 8.6 ReceiveBeginPlay

1. 图类型：BlueprintGraph.EdGraphSchema_K2
1. 模块数：2
1. 连接数：1
1. 执行链：ReceiveBeginPlay -> ExecuteUbergraph_BP_ShowcaseModel_Level3
1. 关键节点：
   - ExecuteUbergraph_BP_ShowcaseModel_Level3
     输入：execute <- ReceiveBeginPlay:then
   - ReceiveBeginPlay

### 8.7 ReturnToLevel3DefaultView
...
### 8.8 TL_DustTransition_5s__FinishedFunc

1. 图类型：BlueprintGraph.EdGraphSchema_K2
1. 模块数：2
1. 连接数：1
1. 执行链：TL_DustTransition_5s__FinishedFunc -> ExecuteUbergraph_BP_ShowcaseModel_Level3
1. 关键节点：
   - ExecuteUbergraph_BP_ShowcaseModel_Level3
     输入：execute <- TL_DustTransition_5s__FinishedFunc:then
   - TL_DustTransition_5s__FinishedFunc

### 8.9 TL_DustTransition_5s__UpdateFunc

1. 图类型：BlueprintGraph.EdGraphSchema_K2
1. 模块数：2
1. 连接数：1
1. 执行链：TL_DustTransition_5s__UpdateFunc -> ExecuteUbergraph_BP_ShowcaseModel_Level3
1. 关键节点：
   - ExecuteUbergraph_BP_ShowcaseModel_Level3
     输入：execute <- TL_DustTransition_5s__UpdateFunc:then
   - TL_DustTransition_5s__UpdateFunc

### 8.10 TL_OilTransition_5s__FinishedFunc

1. 图类型：BlueprintGraph.EdGraphSchema_K2
1. 模块数：2
1. 连接数：1
1. 执行链：TL_OilTransition_5s__FinishedFunc -> ExecuteUbergraph_BP_ShowcaseModel_Level3
1. 关键节点：
   - ExecuteUbergraph_BP_ShowcaseModel_Level3
     输入：execute <- TL_OilTransition_5s__FinishedFunc:then
   - TL_OilTransition_5s__FinishedFunc

### 8.11 TL_OilTransition_5s__UpdateFunc

1. 图类型：BlueprintGraph.EdGraphSchema_K2
1. 模块数：2
1. 连接数：1
1. 执行链：TL_OilTransition_5s__UpdateFunc -> ExecuteUbergraph_BP_ShowcaseModel_Level3
1. 关键节点：
   - ExecuteUbergraph_BP_ShowcaseModel_Level3
     输入：execute <- TL_OilTransition_5s__UpdateFunc:then
   - TL_OilTransition_5s__UpdateFunc

### 8.12 UpdateDustVisual

1. 图类型：BlueprintGraph.EdGraphSchema_K2
1. 模块数：10
1. 连接数：11
1. 执行链：UpdateDustVisual -> IsValid -> MaterialInstanceDynamic.K2_GetScalarParameterValue -> MaterialInstanceDynamic.K2_GetScalarParameterValue -> Set DustTransitionStart01 -> Set DustTransitionTarget01 -> Event_PlayDustTransition
1. 关键节点：
   - MaterialInstanceDynamic.K2_GetScalarParameterValue
     输入：execute <- MaterialInstanceDynamic.K2_GetScalarParameterValue:then
     输入：self <- Get DustMID_Slot1:DustMID_Slot1
...
### 8.13 UpdateOilVisual

1. 图类型：BlueprintGraph.EdGraphSchema_K2
1. 模块数：10
1. 连接数：11
1. 执行链：UpdateOilVisual -> IsValid -> MaterialInstanceDynamic.K2_GetScalarParameterValue -> MaterialInstanceDynamic.K2_GetScalarParameterValue -> Set OilTransitionStart01 -> Set OilTransitionTarget01 -> Event_PlayOilTransition
1. 关键节点：
   - MaterialInstanceDynamic.K2_GetScalarParameterValue
     输入：execute <- MaterialInstanceDynamic.K2_GetScalarParameterValue:then
     输入：self <- Get OilMID_Slot1:OilMID_Slot1
     输入：ParameterName = OilBlend01
   - Event_PlayOilTransition
     输入：execute <- Set OilTransitionTarget01:then
   - Set OilTransitionTarget01
     输入：execute <- Set OilTransitionStart01:then
     输入：OilTransitionTarget01 <- Get NewParamOilBlend01:NewParamOilBlend01
