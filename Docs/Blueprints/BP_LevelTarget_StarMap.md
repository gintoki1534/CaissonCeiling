# BP_LevelTarget_StarMap

## 1. 蓝图定位

本文档由 Docs/BlueprintExports/BP_LevelTarget_StarMap.json 自动整理生成，用于记录当前蓝图的真实导出结构。

## 2. 基础信息

1. 蓝图名：BP_LevelTarget_StarMap
1. 资源路径：/Script/Engine.Blueprint'/Game/UI/LevelTargets/BP_LevelTarget_StarMap.BP_LevelTarget_StarMap'
1. 蓝图类型：Blueprint
1. 父类：Engine.Actor
1. 生成类：BP_LevelTarget_StarMap_C
...
### 8.4 ExecuteUbergraph_BP_LevelTarget_StarMap
...
1. 执行链：ExecuteUbergraph_BP_LevelTarget_StarMap
1. 关键节点：
